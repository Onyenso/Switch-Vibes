...
spotify_playlist = get_spotify_playlist(id1)

# write parsed Spotify playlist to file
with open("spotify_to_yt_jsons/spotify_playlist1.json", "w") as file:
    json.dump(spotify_playlist, file,indent=4)

# convert parsed Spotify playlist to YT playlist and write to a file
with open("spotify_to_yt_jsons/yt_playlist1.json", "w") as file:
